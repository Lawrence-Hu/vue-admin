    ...
    <div>
        <template>
            ...
            <template slot-scope="scope">
                ...
                <el-button :type="scope.row.status?'success':'danger'" disabled>{{scope.row.status?'已通过':'已驳回'}}</el-button>
            </template>      
            </el-table-column>
        </el-table>
    </template>
        ...
        <el-form :model="form" :inline="true">
           ...
           <el-form-item label="产品名称" label-width="68px">
            ...
            <el-form-item label="信息"  v-model="form.comments">
                <el-input type="textarea" disabled style ="width:250%;height:400%"  v-model="form.comments"></el-input>
            </el-form-item>
        </el-form>
    </el-dialog>
</div>
...
export default {
    ...
    methods: {
      pageChange(curtPage){
        productAudit(this.pageSize,curtPage,true).then((resp)=>{
